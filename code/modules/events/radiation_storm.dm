...
/datum/round_event/radiation_storm/announce()
	...
	priority_announce("High levels of radiation detected approching [station_name]. ETA: [eta_timer] seconds. Proceed to the nearest maintenance tunnel to take cover.", "Radiation Storm", 'sound/AI/radiation_short.ogg')
	//sound doesn't really match but that's ok
